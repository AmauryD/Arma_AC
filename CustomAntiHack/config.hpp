...
class variablesCfg {
  ...
  class variables {
    ...
    allowed[] = { // no problem if has not the allowed tag
        ...
        /* 
        % can be number (1,2,3,4) 
        %% 2 numbers (12,19,14)
        ...
        usefull when you have formated vars or many vars
        */
        "medic_%", 
        "dp_%","dp_%%",
        "cop_%","cop_%%",
        ...
        "dep_%",
        "dealer_%","dealer_%_%",
        "cheat%", // why ? i don't know , maybe an addon

        "ac_fnc_cfgstringnbr",
        "ac_fnc_cfgstringnbr_meta",
        "ac_fnc_strtok",
        "ac_fnc_strtok_meta",
        ...
        "ac_fnc_onspawntypechanged",
        "off",
        "dfyre_a_core_effects_df_wr_katiba",
        "jsrs2_distance_effects_mx",
        "l_es_dfyre_foresta_hmg_sd",
        "dfyre_a_core_effects_df_wh_missile",
        "dfyre_a_core_effects_rocketexplo",
        "l_es_dfyre_foresta_rifle2_sd",
        "dfyre_a_core_effects_df_wh_hmg",
        "dfyre_explo",
        "jsrs2_distance_effects_hmg_127",
        "dfyre_a_core_effects_df_wp_fnp",
        "l_es_dfyre_urbanarrayssd",
        "dfyre_rocket_flybyarrays",
        "jsrs2_distance_effects_fal",
        "l_es_dfyre_urbana_rifle2_sd",
        "l_es_dfyre_urbana_pistol2_sd",
        "jsrs2_distance_effects_gmg20",
        "l_es_dfyre_urbana_rifle1_sd",
        ...
        "ac_fnc_onspawnedclick",
        "ac_fnc_updatespawnedlist_meta",
        "ac_fnc_updatespawnedlist",
